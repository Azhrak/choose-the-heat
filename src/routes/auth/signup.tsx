    ...
    <div className="min-h-screen bg-gradient-to-br from-romance-50 via-white to-romance-100 flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 mt-2">Start your personalized romance journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className={cn(
              ...
              loading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-romance-700'
            )}
          >
        ...
        <p className="mt-6 text-center text-sm text-slate-600">
          ...
          <Link to="/auth/login" className="text-romance-600 font-medium hover:text-romance-700">
            Sign in
          </Link>
        </p>
      </div>
