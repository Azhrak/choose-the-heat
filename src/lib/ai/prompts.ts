...
export function buildSystemPrompt(preferences: StoryPreferences): string {
	...
	const pacingDescription = {
		"slow-burn":
			"Develop the relationship gradually with careful attention to emotional build-up and tension",
		"fast-paced":
			"Move the relationship forward with engaging momentum and quick chemistry",
	};
