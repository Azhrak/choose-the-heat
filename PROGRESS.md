...
- ✅ Google OAuth integration (Arctic library)
- ✅ Email/password authentication (Argon2 hashing)
- ✅ Secure session management (httpOnly, SameSite, Secure cookies)
- ✅ 30-day session expiry
- ✅ Password strength validation
- ✅ Account linking (OAuth + email for same user)
- ✅ Beautiful login/signup UI with Google button
...
- ✅ Vercel AI SDK integration with multiple providers
- ✅ **4 AI providers supported:** OpenAI, Google Gemini, Anthropic Claude, Mistral AI
- ✅ Provider-agnostic interface (easy to switch between providers)
- ✅ Model customization per provider via environment variables
- ✅ Built-in streaming support and error handling
- ✅ Dynamic system prompts based on user preferences
- ✅ Scene generation with context from previous scenes
- ✅ Choice impact reflection in story
- ✅ Story progression awareness (beginning, middle, climax, resolution)
- ✅ Scene caching in database (avoid regeneration costs)
- ✅ Validation for scene quality (word count, no placeholders)
- ✅ Comprehensive provider documentation ([AI_PROVIDERS.md](AI_PROVIDERS.md))
